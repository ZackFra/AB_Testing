...
this approximation, compute P(X > pˆB). Use the R function pnorm, or
...
```
(d) Should you reject the null hypothesis pB ≤ pA? Why?
...
(e) What if you had observed the same pˆB = 0.6 but with n = 100
...
(f) What is the smallest value pˆB you would reject the null hypothesis
...
The smallest value we should accept, qb, is 0.580581.

(g) Based on (f ), the smallest detectable improvement for pA = 0.5 with 
n = 100 is then qB − pA. What is the smallest detectable improvement in your
experiment (that is, with n = 50)?
...
(d) What if you had observed the same pˆB = 0.6 but with n = 100 samples.
...
(f) Based on (e), the smallest detectable improvement for pA = 0.75 with n
= 100 is then qB − pA. What is the smallest detectable improvement in your
experiment (n = 50)?
...
(d) What is your estimate yˆ of pB − pA based on the data your recorded for this experiment?
...
(e) Using the CLT approximation, what is P(Y > yˆ)
...
Why? Remember, we are using α = 0.05.
